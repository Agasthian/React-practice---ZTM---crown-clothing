...
//checkuserSession action is called from app.js in useEffect
//A saga is listening for in user.saga.js
...
export const signInSuccess = (user) => createAction(
    USER_ACTION_TYPES.SIGN_IN_SUCCESS, user
)
...
export const signUpSuccess = (user, additionalDetails) => createAction(
    USER_ACTION_TYPES.SIGN_IN_SUCCESS, {user, additionalDetails}
)
